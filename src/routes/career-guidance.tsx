  ...
  head: () => ({
    meta: [
      { title: "Career Guidance — High-Paying Careers in 2026 | EduGuide" },
      {
        name: "description",
        content:
          "Explore the fastest-growing, highest-paying careers and the courses that lead to them.",
      },
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        title="Build a career that compounds over time"
          ...
          >
            ...
            <div className="mt-5 grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <div className="font-display font-bold text-primary text-lg">{c.salary}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Growth</div>
                <div className="font-display font-bold text-accent-foreground text-lg">
                  {c.growth}
                </div>
              </div>
            </div>
