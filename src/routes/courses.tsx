  ...
  head: () => ({
    meta: [
      { title: "Courses — Career-Focused Online Programs | EduGuide" },
      {
        name: "description",
        content:
          "Explore career-oriented courses in AI, data science, cybersecurity, design and more. Build skills that lead to high-paying jobs.",
      },
      { property: "og:title", content: "Courses | EduGuide" },
      {
        property: "og:description",
        content: "Career-aligned courses across top online learning platforms.",
      },
