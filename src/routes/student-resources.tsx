  ...
  head: () => ({
    meta: [
      { title: "Student Resources — Free Tools & Guides | EduGuide" },
      {
        name: "description",
        content:
          "Free tools, study guides, application templates and resources for students worldwide.",
      },
...
const RES = [
  {
    ...
    desc: "Sample SOPs, scholarship essays and personal statements.",
  },
  {
    icon: Calculator,
    title: "Cost Calculators",
    desc: "Estimate the total cost of studying abroad by country.",
  },
  {
    icon: Languages,
    title: "IELTS / TOEFL Prep",
    desc: "Free resources to boost your English proficiency score.",
  },
  {
    icon: BookOpen,
    title: "Study Techniques",
    desc: "Science-backed methods to learn faster and retain more.",
  },
  {
    icon: Lightbulb,
    title: "Career Quizzes",
    desc: "Discover careers that match your strengths and interests.",
  },
  {
    icon: Users,
    title: "Mentor Network",
    desc: "Connect with alumni and current students worldwide.",
  },
];
