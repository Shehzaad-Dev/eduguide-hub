  ...
  return (
    <PageShell>
      <article className="container-px mx-auto max-w-3xl py-16">
        ...
        <h1 className="mt-5 text-4xl md:text-5xl font-bold text-secondary leading-tight">
          {article.title}
        </h1>
        ...
        <div className="prose-lg mt-10 space-y-6 text-foreground leading-relaxed">
          <p>
            {article.excerpt} In this comprehensive guide, the EduGuide editorial team breaks down
            everything ambitious students need to know in 2026 — eligibility, deadlines, application
            strategy, and the long-term career impact.
          </p>
          <h2 className="text-2xl font-bold text-secondary mt-10">Why this matters</h2>
          <p>
            Choosing the right opportunity early in your academic journey can shape the next decade
            of your career. Whether you're applying for a fully funded scholarship or selecting a
            high-ROI online certification, the right decision compounds over time.
          </p>
          ...
          <p>
            Most programs open applications 9–12 months before the academic year begins. Start
          ...
          <p>
            ...
            labour-market data, candidates with relevant credentials earn 25–40% more within five
            years compared to peers without.
          </p>
          ...
          <div className="space-y-4">
            <details className="p-5 rounded-xl bg-soft border border-border">
              ...
              <p className="mt-3 text-muted-foreground">
                Yes — eligibility is global for most programs covered in this guide. Specific
                country quotas may apply.
              </p>
            </details>
            <details className="p-5 rounded-xl bg-soft border border-border">
              <summary className="font-semibold cursor-pointer">
              ...
              <p className="mt-3 text-muted-foreground">
                Acceptance rates vary widely — from under 5% for elite programs to 30%+ for niche
                scholarships. Strong essays make the biggest difference.
              </p>
            </details>
            <details className="p-5 rounded-xl bg-soft border border-border">
              <summary className="font-semibold cursor-pointer">Do I need work experience?</summary>
              <p className="mt-3 text-muted-foreground">
                Most undergraduate programs do not require it. Many graduate programs prefer 1–3
