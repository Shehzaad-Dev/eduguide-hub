...
export const Route = createFileRoute("/online-learning")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Compare Coursera, edX, Udemy, FutureLearn and more. Find the right platform for your career goals." },
...
function Page() {
  return (
    <PageShell>
      <PageHeader eyebrow="Online Learning" title="The best learning platforms in 2026"
      ...
      <section className="container-px mx-auto max-w-7xl py-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {PLATFORMS.map((p) => (
          <a key={p.name} href={p.url} target="_blank" rel="noopener noreferrer"
            ...
            <div className="font-display font-bold text-xl text-secondary group-hover:text-primary transition-colors">{p.name}</div>
