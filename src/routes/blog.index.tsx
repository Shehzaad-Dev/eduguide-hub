  ...
  head: () => ({
    meta: [
      { title: "Blog — Education, Scholarships & Career Insights | EduGuide" },
      {
        name: "description",
        content:
          "Articles on scholarships, study abroad, careers in AI and tech, and online learning. Expert guides for ambitious students.",
      },
      { property: "og:title", content: "EduGuide Blog" },
      {
        property: "og:description",
        content: "Expert guides for scholarships, study abroad and careers.",
      },
            ...
            >
              ...
              <div className="mt-5 flex items-center justify-between text-xs text-muted-foreground">
                <span className="inline-flex items-center gap-1">
                  <Clock className="w-3.5 h-3.5" /> {a.readingTime} min
                </span>
                <span>
