...
export const PLATFORMS = [
  {
    ...
    tagline: "Degrees & certificates from top universities",
  },
  ...
  { name: "Udemy", url: "https://www.udemy.com/", tagline: "Affordable courses on every skill" },
  {
    ...
    tagline: "UK universities & social learning",
  },
  {
    name: "Khan Academy",
  ...
  { name: "Codecademy", url: "https://www.codecademy.com/", tagline: "Hands-on coding lessons" },
  {
    ...
    tagline: "Career-aligned skill paths",
  },
];
...
export const TESTIMONIALS = [
  {
    name: "Ayesha K.",
    role: "Chevening Scholar, UK",
    quote:
      "EduGuide's step-by-step scholarship guide made my Chevening application stress-free. I'm now studying at LSE!",
  },
  {
    name: "Daniel O.",
    role: "DAAD Scholar, Germany",
    quote:
      "The Germany study guide answered every question. I landed a fully funded master's at TU Munich.",
  },
  {
    name: "Maya R.",
    role: "MIT Undergraduate",
    quote:
      "Their university comparison helped me choose MIT. The career path articles still guide my internships.",
  },
];
